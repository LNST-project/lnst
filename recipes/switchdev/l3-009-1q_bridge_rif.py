...
def do_task(ctl, hosts, ifaces, aliases):
    ...
    sw_br = sw.create_bridge(slaves=[sw_if1, sw_if3],
                             options={"vlan_filtering": 1})
    sw_if1.add_br_vlan(10)
    sw_if3.add_br_vlan(10)
    sw_br.add_br_vlan(10, self=True)
    sw_br_v10 = sw.create_vlan(sw_br, 10, ip=test_ip(1, 10))
    ...
    m1_if1.add_nhs_route(ipv4(test_ip(2, 0)), [str(sw_br_v10.get_ip(0))])
