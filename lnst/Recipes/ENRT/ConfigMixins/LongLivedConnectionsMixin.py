...
from lnst.Agent.conditions.WaitForEstablishedConnections import (
...
class LongLivedConnectionsMixin:
    ...
    def test_wide_configuration(self):
        ...
        host1.keep_addrs_on_dev_down(host1.eth0)
        host2.keep_addrs_on_dev_down(host2.eth0)
    ...
    def test_wide_deconfiguration(self, config):
        ...
        host1.remove_addrs_on_dev_down(host1.eth0)
        host2.remove_addrs_on_dev_down(host2.eth0)
        ...
        for parent_config in super().generate_sub_configurations(config):
            ...
            for ip_version in self.params.ip_versions:
                ...
                for i, endpoint_pair in enumerate(filtered_ips):
                    ...
                    parent_config.long_lived_connections.append(
                        (client_job, server_job)
                    )
