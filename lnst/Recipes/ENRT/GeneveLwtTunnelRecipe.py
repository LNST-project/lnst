...
class GeneveLwtTunnelRecipe(
    ...
    def create_tunnel(
        ...
        config.configure_and_track_ip_bulk([(m1.gnv_tunnel, m1_dummy_ips + m1_dummy_ips6)])
        config.configure_and_track_ip_bulk([(m2.gnv_tunnel, m2_dummy_ips + m2_dummy_ips6)])
