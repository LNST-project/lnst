...
class GeneveIpsecOvsTunnelRecipe(
    ...
    """
    This class implements a recipe that configures a Geneve tunnel and IPSec using
    two OpenVSwitch bridges between two hosts.
    ...
    def create_tunnel(
        ...
        for i, (host, endpoint) in enumerate([(m1, endpoint2), (m2, endpoint1)], 1):
            ...
            local_ip = config.ips_for_device(host.br_ex)[0]
