...
class VirtualOvsBridgeVlansOverBondRecipe(VlanPingEvaluatorMixin,
    ...
    """
       ...
       |  | eth0  |          | eth1  | |           |  | eth0  |          | eth1  | |
       |  +---+---+          +---+---+ |           |  +---+---+          +---+---+ |
       |      |    "bond_port1"      | |           |      |    "bond_port2"      | |
       |      +---------+------------+ |           |      +---------+------------+ |
       |                |              |           |                |              |
       |      +---------v----------+   |           |      +---------v----------+   |
       |      |    OVS BRIDGE 0    |   |           |      |    OVS BRIDGE 0    |   |
       |      |                    |   |           |      |                    |   |
       ...
       |          |            |       |           |          |            |       |
       |        tap0          tap1     |           |        tap0          tap1     |
       |__________|_____________|______|           |__________|_____________|______|
                  |             |                             |             |
        __________|_____        |_______            __________|_____        |_______
       |    GUEST 1     |      | GUEST 2|          |    GUEST 3     |      | GUEST 4|
       |     eth0       |      |  eth0  |          |     eth0       |      |  eth0  |
       | (192.168.10.x) |      |(192.168|          | (192.168.10.x) |      |(192.168|
       |________________|      |_.20.x)_|          |________________|      |_.20.x)_|
    """
