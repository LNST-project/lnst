"""
Defines the ImportantRunSummaryFormatter class which is can be used to
process a RecipeRun object to return a formatted run summary string.
...
class HumanReadableRunSummaryFormatter(RunSummaryFormatter):
